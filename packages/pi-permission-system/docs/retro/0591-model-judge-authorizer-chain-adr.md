...
- Filed no follow-up issues: [#472] stays the implementation umbrella carrying the ADR, and its own decomposition (chain infra, slice 1, slice 2, downstream package) is [#472]'s planning concern — filing now would be speculative.
